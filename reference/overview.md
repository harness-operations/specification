...
Reference Model 0.1 intentionally does not define a Harness Operations wire protocol.
...
Harness Operations 0.1 organizes operational state into three broad categories.
...
This document introduces the discipline and its scope. The remaining Reference Model 0.1 documents define the details:
